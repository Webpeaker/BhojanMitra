import { FaCheckCircle, FaExclamationTriangle, FaTimesCircle, FaEnvelope, FaLock, FaArrowRight } from 'react-icons/fa';
      ...
      <div className="legal-body">
        <div className="container" style={{ maxWidth: 860 }}>
          ...
          <div className="refund-scenarios">
            {scenarios.map(({ Icon, title, color, items }, i) => (
              <div key={i} className="refund-card" style={{ '--sc-color': color }}>
          ...
          <div className="refund-cta">
            ...
            <p>Our support team is available 7 days a week to resolve any billing issues.</p>
